...
public struct Services_Caches_Search_Nearest: Request {
	public var baseURLString: String
	public let path = "services/caches/search/nearest"
	...
	//TODO:location_source parameter needs to be implemented
//	public var locationSource: Double?
	...
	public var query: [String: String] {
		...
		query["center"] = self.center.stringValue
		query["radius"] = self.radius.map(String.init)
	...
	public init(baseURLString: String, center: CLLocationCoordinate2D) {
...
extension Services_Caches_Search_Nearest: SearchRequestType { }
